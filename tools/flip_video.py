...
if __name__ == "__main__":
    ...
    IDE_INPUT_FILES = [
        # r"./15/1.16_15/gallery_15_topcenter.mp4",
        # r"./15/1.16_15/gallery_15_topleft.mp4",
        # r"./15/1.16_15/gallery_15_topright.mp4",
        # r"./15/1.16_15/star_15_topcenter.mp4",
        # r"./15/1.16_15/star_15_topleft.mp4",
        # r"./15/1.16_15/star_15_topright.mp4",
        # r"./15/1.16_15/sword_15_topcenter.mp4",
        # r"./15/1.16_15/sword_15_topleft.mp4",
        # r"./15/1.16_15/sword_15_topright.mp4",
        # r"./15/1.16_15/travel_15_topcenter.mp4",
        # r"./15/1.16_15/travel_15_topleft.mp4",
        # r"./15/1.16_15/travel_15_topright.mp4",
        # r"./15/1.16_15/trove_15_topcenter.mp4",
        # r"./15/1.16_15/trove_15_topleft.mp4",
        # r"./15/1.16_15/trove_15_topright.mp4",
