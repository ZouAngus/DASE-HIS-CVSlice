% =========================================================================
% CAVEAT — 3DV 2027 draft (target deadline: Aug 28, 2026 AoE)
% -------------------------------------------------------------------------
...
\DATASET{} (\textbf{CAVE} \textbf{A}c\textbf{T}ions), the first HAR
benchmark captured inside an operational projection-based CAVE---and, we
hope, a literal caveat for models benchmarked only in conventional
laboratories. It provides synchronized multi-view RGB video from
...
We close this gap with \DATASET{} (\textbf{CAVE}
\textbf{A}c\textbf{T}ions), captured in a
