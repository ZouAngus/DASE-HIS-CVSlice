...
│   │
│   └── ui/                      # 界面
│       ├── main_window.py       # 主窗口 ClipAnnotator (核心逻辑)
│       ├── skeleton_corrector.py # 骨骼校正窗口
│       └── video_label.py       # 可拖拽的 QLabel (鼠标事件转发)
│
├── tools/                       # 独立工具脚本
│   ├── extract_24_keypoint_from_csv.py  # 从 CSV 提取 24 关键点
│   └── flip_video.py            # 水平翻转视频
│
└── dist/
    └── CVSlice.exe              # PyInstaller 单文件打包
```
